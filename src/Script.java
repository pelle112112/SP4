public class Script {
    ...
    String text41 = "Cardinal: \"Thanks for helping me out, but did I really need your help afterall? Well take my sword anyway and be gone!\n"
    ...
    String text5= "System:"+"A great entrance hall, full of light. A lonely soul stands in the corner scared for his life" ;
    ...
    String text7= "The locked door requires a very large specific key looted from >The Imp-aler< who is said to be further inside the dungeon";
    String text8= "Maiden Luanda:\n" +
    ...
    String text9= "Maiden Luanda:\n" +
            "\t\"Thank you kind stranger for helping me get through the door\"\n" +
            "\t\"Here take this potion as a sign of my gratitude\"";
    String text10 = "Maiden Luanda \"Oh my that's imp-ossible, i did not expect to meet <\"The Imp-aster\">\n" +
            "\tMaiden Luanda \"I will help you take him down ";
    String text11 ="Two doors one goes up the other to the right ";
    String text12 = "Miaden Luanda \"Oh well i ended up not being helpfull at all";
    String text13= " System: \"The boss dropped a note, you pick it up and begin to read it\"\n" +
            "\tSystem:\"The princess has been captured while everyone was asleep, not a single soul awoke when we kidnapped her, since their food was filled with sleepingpills.\" \n" +
    ...
    String text15= "The room is pitch black, there is a single lantern casting off some light.";
   ...
   // room 8
    ...
    String text24 = "Goblin-King \"GET OUT OF MY DUNGEON YOU FILTHY PEASANT\"" +
            "\n Player:"+ "No i dont think i will\n" +
            "Goblin-King" + "I WILL PERSONALLY CALL UPON THE IMP-ALER TO THROW YOU OUT OF MY DUNGEON AND EAT YOU ALIVE WHILE THE PRINCESS AND I WIL BE WATCHING\n" +
            "Player:"+ "But he is alreaddy dead\n" +
            "System:"+"You throw the IMP-ALER's head infront of the Goblin-King\n" +
            "Goblin-King"+ "WHAT?? HOW IS THAT POSSBILE??\n" +
            "Player:"+"Well that only leaves you...\n"
            +"SYSTEM:"+"WHO DO YOU VOTE FOR TO WIN THE FINAL BATTLE? THE GRUSOME GOBLIN-KING OR THE SAVIOR OF THE WORLD THE PLAYER?\n" +
    ...
    String text25 = "System: \"You defeated the Goblin-king and returned to the kingdom with the princess\"\n" +
